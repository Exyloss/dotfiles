...
let s:gb.bright_red     = ['#E74263', 167]     " 251-73-52
let s:gb.bright_green   = ['#57C59B', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#f3c852', 214]     " 250-189-47
let s:gb.bright_blue    = ['#796D8B', 109]     " 131-165-152
let s:gb.bright_purple  = ['#B67CCF', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:gb.bright_orange  = ['#FF7D56', 208]     " 254-128-25

let s:gb.neutral_red    = ['#D63152', 124]     " 204-36-29
let s:gb.neutral_green  = ['#46B48A', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#f2b741', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#685C7A', 66]      " 69-133-136
let s:gb.neutral_purple = ['#A56BBF', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#689d6a', 72]      " 104-157-106
let s:gb.neutral_orange = ['#EE6C45', 166]     " 214-93-14

let s:gb.faded_red      = ['#C52041', 88]      " 157-0-6
let s:gb.faded_green    = ['#35A373', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#E1A630', 136]     " 181-118-20
let s:gb.faded_blue     = ['#574B69', 24]      " 7-102-120
let s:gb.faded_purple   = ['#945AAE', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#578C59', 66]      " 66-123-88
let s:gb.faded_orange   = ['#DD5B34', 130]     " 175-58-3
...
if s:is_dark
  ...
  let s:bg_visual  = s:gb.faded_aqua
...
call s:HL('Visual',    s:none,  s:bg_visual)
